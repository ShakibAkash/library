...
<div class="page-header">
    <h1><i class="fas fa-plus-circle me-3"></i>New Borrowing Record</h1>
    <p class="text-muted mb-0">Register a new book borrowing transaction</p>
</div>
...
<div class="form-card">
    <form action="{{ route('borrowings.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="date" name="dateborrowed" id="dateborrowed" class="form-control" required>
            @error('dateborrowed')
                <div class="text-danger mt-1"><small>{{ $message }}</small></div>
            @enderror
        </div>
