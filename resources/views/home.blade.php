...
<head>
    ...
    <style>
        ...
        body.dark-mode .banner {
            background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('{{ asset("images/librarybanner.jpg") }}') no-repeat center center;
            background-size: cover;
        }
        
        body.dark-mode .banner::before {
            background: linear-gradient(45deg, rgba(30, 60, 114, 0.3), rgba(139, 69, 19, 0.2));
        }
